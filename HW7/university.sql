...
CREATE OR REPLACE TRIGGER course_num
    BEFORE INSERT OR UPDATE on COURSE
    FOR EACH ROW
    WHEN (NEW.coursenr >= 599)
    DECLARE
        coursenr varchar(3) := 598;
    BEGIN
        :NEW.coursenr := coursenr;
        DBMS_OUTPUT.PUT_LINE('Insert or Update on Course Table');
    END;
...
insert into creditcard values ('1234 5678 1234 5678');
insert into creditcard values ('9999-2222-7777-9999');
insert into creditcard values ('1234 5678 1234 4444');
insert into creditcard values ('8888-2222 9999 1234');
insert into creditcard values ('1234567812345678');
insert into creditcard values ('999922227777-9999');
insert into creditcard values ('1234567812344444');
insert into creditcard values ('8888222299991234');

-- Get all numbers containing spaces.
SELECT * FROM creditcard
WHERE REGEXP_LIKE (ccard, '\d{3}\s');

-- Get all numbers containing dashes.
SELECT * FROM creditcard
WHERE REGEXP_LIKE (ccard, '\d{3}+-');
